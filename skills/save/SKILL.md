...
Before creating the session note, consult the vault's methodology mode via `bash scripts/python-bin.sh scripts/wiki-mode.py route session "<topic-summary>"`. The router returns the vault-relative path:
